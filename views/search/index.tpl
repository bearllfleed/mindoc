...
<head>
    ...
    <title>{{i18n .Lang "search.title"}} - Powered by 牧牛火链</title>
    <meta name="keywords" content="牧牛火链,文档在线管理系统,WIKI,wiki,wiki在线,文档在线管理,接口文档在线管理,接口文档管理,{{.Keyword}}">
    <meta name="description" content="牧牛火链文档在线管理系统 {{.site_description}}">
    <!-- Bootstrap -->
